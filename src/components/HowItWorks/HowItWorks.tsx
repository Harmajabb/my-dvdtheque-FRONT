      ...
      <div className="container-custom">
        ...
        <div className="max-w-[700px] mx-auto">
          {steps.map((step, index) => (
            <Reveal key={step.id} variant="fade-in-left" delay={index * 200}>
              <article className="grid grid-cols-[auto_1fr] gap-8 mb-10 last:mb-0 max-md:gap-6 max-md:mb-8 max-[480px]:gap-4">
