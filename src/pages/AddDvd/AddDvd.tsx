...
function AddDvd() {
  ...
  const [formData, setFormData] = useState({
    ...
    image_url: "",
    emplacement: "",
    //as is a command which allows to stay this is one of those three
    statut: "en collection" as Dvd["statut"], //because of en collection | prete | perdu
    prete_a: "",
    date_pret: "",
    notes_perso: "",
  });
  ...
  const handleSubmit = async (e: React.SyntheticEvent) => {
    ...
    try {
      const dvdData = {
        //transform the object in a pairs
        ...Object.fromEntries(
          //the filter is remove the empty field of the tab
          // you keep the element where the value isn't ""
          Object.entries(formData).filter(([_, v]) => v !== ""),
        ),
        //transform in number after the string
        annee: formData.annee ? parseInt(formData.annee, 10) : undefined,
        duree: formData.duree ? parseInt(formData.duree, 10) : undefined,
      };
      await createDvd(dvdData);
      ...
      <div className="container-custom py-8">
        ...
        >
            ...
            <div className="space-y-6">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  {/* .map transform every genre in option */}
                  {genres.map((g) => (
                    //unique key for genre, value for backend {g} for user
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  className="form-input bg-zinc-700 border-zinc-600 text-white placeholder-zinc-400"
                />
                {/* img preview if only the img_url isn't empty */}
                {formData.image_url && (
                  <img
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      //we cast the dvd[statut] for type and e.target.value for conversion in string
          ...
          <div className="flex justify-end gap-4 pt-6 border-t border-zinc-700">
            ...
            >
              {loading ? "Ajout en cours..." : "Ajouter le DVD"}
            </button>
          </div>
        </form>
      </div>
